...
import { importExclusions, addExclusion, applyExclusionsToExisting } from './src/exclusions.js';
...
import { pairWhatsApp } from './src/wa/client.js';
...
const HELP = `
  ...
  onboarding
    node cli.js whatsapp-pair                         link WhatsApp by QR once
...
switch (cmd) {
  ...
  case 'exclude': {
    if (opt('file')) importExclusions(opt('file'), opt('reason', 'contacted'));
      ...
      console.log('  need --file=, --name= or --apply');
      break;
    }
